...
public class QuestLine {
    ...
    public QuestLine(Joueur j){
        ...
        quetes.add(new TalkQuete("Chapitre 0 - Le début de l'aventure", "préparez vous au mieux pour un magnifique monde de fantaisie", 10, "Potion", 1, "spectre"));
        quetes.add(new TalkQuete("Chapitre 1 - Le royaume d'Eldoria", "\n" +
                "Il était une fois, dans un monde de fantaisie peuplé de créatures magiques et de héros intrépides, un royaume appelé Eldoria. \nEldoria était un endroit où la magie régnait en maître, et où les aventuriers se lançaient dans des quêtes épiques pour conquérir des trésors inestimables et vaincre des monstres redoutables.", 5, "Commit", 1, "vendeur"));
        quetes.add(new TalkQuete("Chapitre 1 - Le royaume d'Eldoria", "'Salut à toi héros ici tu trouveras tout ce qu'il te faut, va voir le forgeron pour acheter des armes ou traiter tes minerais'\nAller parler au forgeron au sud de la ville.", 5, "Miel", 1, "upgrader"));
        quetes.add(new LootQuete("Chapitre 1 - Le royaume d'Eldoria", "'Si tu veux acheter du nouveau matos c'est ici que ça se passe ! Tiens d'ailleurs, rend moi un service tu veux.'\nMiner une source de minerai à l'est.", 10, "Fer", 1, "SourceMinerai", 1));
        quetes.add(new TalkQuete("Chapitre 1 - Le royaume d'Eldoria", "'Il faudrait peut-etre que je me renseigne à propos de ce livre, une fois que j'aurai amener la marchandise biensur'\nAmener les minerais au forgeron.", 40, "Fer", 3, "upgrader"));
